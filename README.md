...
| Skill-SD | https://arxiv.org/abs/2604.10674 | 2026.04 | — | arXiv 2604.10674 · project | Skill-SD — skill-conditioned self-distillation for multi-turn LLM agents (AppWorld + Sokoban) |
| TCOD | https://arxiv.org/abs/2604.24005 | 2026.04 | Tongyi Lab, Alibaba / CUHK | arXiv 2604.24005 · code | TCOD — temporal curriculum OPD for multi-turn agents; F2B & B2F schedules |
| Healthcare AI GYM | https://arxiv.org/abs/2605.02943 | 2026.05 | Upstage AI / Korea University | arXiv 2605.02943 | Healthcare AI GYM — medical agent RL environment + TT-OPD (turn-level truncated OPD) |
| HyperEyes | <img src="https://img.shields.io/github/stars/Guankai-Li/HyperEyes?style=for-the-badge&logo=github&logoColor=white&labelColor=181717&color=ffd700" alt="Stars"> | 2026.05 | Xiaohongshu / Cambridge | arXiv 2605.07177 · project | HyperEyes — parallel multimodal search agent with dual-grained efficiency-aware RL (TRACE + OPD) |
...
| HyperEyes | Parallel multimodal search agent | External teacher|  TRACE (trajectory-level adaptive cost efficiency) + OPD (token-level) + GRPO  | Macro (trajectory) + micro (token) dual-grained; 5.3x fewer tool calls vs. serial agents; +9.9% accuracy; parallel grounded search decouples entity ID from reasoning; IMEB benchmark  |
